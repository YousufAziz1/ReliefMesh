...
> *"ReliefMesh is a testnet prototype for proof-backed cross-chain aid coordination. It combines real public testnet references with an explicit simulation/live separation and demonstrates how Attestcoin proof flow, Creditcoin accounting and replay protection can work together."*
